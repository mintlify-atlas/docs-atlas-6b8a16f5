...
description: "Overview of the Carnero.Dev source directory layout: pages, components, layouts, lib, styles, and public assets."
---
...
<CardGroup cols={2}>
  <Card title="src/components" icon="puzzle-piece">
    All UI is broken into focused Astro components. The homepage (`index.astro`) imports and assembles them in sequence, from `<Hero />` at the top through `<Footer />` at the bottom. Each component is self-contained with its own markup and scoped styles.
  </Card>

...
<Steps>
  ...
  <Step title="Configure environment variables">
    Create a `.env` file at the project root and populate it with your Supabase and Resend credentials. The application will not connect to the database or send emails without these values.
    ...
    See the [Environment Setup](/dev/environment-setup) guide for step-by-step instructions on finding each value.
  </Step>

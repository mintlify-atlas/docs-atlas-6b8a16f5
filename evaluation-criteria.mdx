---
title: "How Projects Are Judged at Carnero.Dev"
...
<CardGroup cols={2}>
  ...
  <Card title="Final Presentation — 10%" icon="presentation-screen" href="/evaluation-criteria">
    Rates the **clarity and persuasiveness of the 3-minute pitch**, including the quality of supporting slides and the team's ability to field technical and business questions during the Q&A. Conciseness, structure, and confidence all factor into this score.
  </Card>
</CardGroup>
...
The final presentation follows a strict two-part format:

- **3 minutes of presentation** — your team presents the problem, the solution, a live demo, and the technology stack to the full judge panel on stage. All team members may participate, but time is absolute.
- **2 minutes of Q&A** — judges ask follow-up questions covering technical decisions, scalability, business viability, and design choices. Answers given during Q&A can meaningfully move your scores in both the *Technical Function* and *Final Presentation* categories.

Every registered team **must present on stage** to receive a score. Teams that skip the final pitch receive no grade, regardless of their project's quality.
...
<Card title="Mención de Innovación Disruptiva" icon="trophy" href="/evaluation-criteria">
...
<Card title="Mención de Diseño & UX" icon="star" href="/evaluation-criteria">

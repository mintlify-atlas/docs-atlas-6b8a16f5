...
<AccordionGroup>
  ...
  <Accordion title="What is the maximum team size?">
    ...
    <Note>
      The team size stated here reflects the FAQ component (3–5 members). For the official registration requirement, refer to the [rules and eligibility](/rules-and-eligibility) page.
    </Note>
  </Accordion>
  ...
  <Accordion title="How are winning projects evaluated?">
    ...
    <Note>
      The four criteria above (25% each) reflect the scoring breakdown in the FAQ component. For the full official judging rubric, see the [evaluation criteria](/evaluation-criteria) page.
    </Note>
  </Accordion>
</AccordionGroup>

---
title: "Carnero.Dev Hackathon: Full Team Registration Guide"
...
<ParamField body="membersCount" type="string" required>
  Total number of team members, including the representative/leader. Submitted as a string from the radio button selection. Must resolve to an integer between **1** and **4** (inclusive). Values outside this range are rejected by the server.
